            ...
            <div className="flex-btn sm:w-auto w-full gap-5">
              <button
                ...
                className={`bg-white hover:text-subMain *:
                  ...
                  transitions bg-opacity-30  rounded px-4 py-2 text-sm`}
              >
                <FaHeart />
              </button>
              <button
                ...
                className="bg-subMain flex-rows gap-2  hover:text-main transitions font-medium text-white rounded px-4 py-2 text-sm"
              >
        ...
        {play ? (
          ...
          <div className="w-full h-screen rounded-lg overflow-hidden relative">
            {isLoading ? (
              ...
              <div className={sameClass}>
                <div className="flex-colo w-24 h-24 p-5 mb-0 rounded-full bg-main text-subMain text-4xl">
                  <RiMovie2Line />
                </div>
              ...
              <>
                ...
                <img
                  src={movie?.image ? movie?.image : "/assets/movies/user.png"}
                  alt={movie?.name}
