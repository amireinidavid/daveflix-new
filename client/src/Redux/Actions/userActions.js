...
const updateProfileAction = (user) => async (dispatch, getState) => {
  try {
    ...
    dispatch({
      type: userConstants.USER_UPDATE_PROFILE_SUCESS,
      payload: response,
    });
...
const deleteProfileAcion = () => async (dispatch, getState) => {
  try {
    dispatch({ type: userConstants.USER_DELETE_PROFILE_REQUEST });
    await userApi.deleteProfileService(tokenProtection(getState));
    dispatch({ type: userConstants.USER_DELETE_PROFILE_SUCESS });
...
const changePasswordAction = (passwords) => async (dispatch, getState) => {
  try {
    ...
    dispatch({
      type: userConstants.USER_CHANGE_PASSWORD_SUCESS,
      payload: response,
    });
  } catch (error) {
...
const getFavoriteMoviesAction = () => async (dispatch, getState) => {
  try {
    ...
    dispatch({
      type: userConstants.GET_FAVORITE_MOVIES_SUCESS,
      payload: response,
    });
  } catch (error) {
...
const deleteFavoriteMoviesAction = () => async (dispatch, getState) => {
  try {
    ...
    dispatch({ type: userConstants.DELETE_FAVORITE_MOVIES_SUCESS });
...
const getAllUsersAction = () => async (dispatch, getState) => {
  try {
    ...
    dispatch({
      type: userConstants.GET_ALL_USERS_SUCESS,
      payload: response,
    });
  } catch (error) {
...
const deleteUserAction = (id) => async (dispatch, getState) => {
  try {
    ...
    dispatch({ type: userConstants.DELETE_USER_SUCESS });
...
const likeMovieAction = (movieId) => async (dispatch, getState) => {
  try {
    ...
    dispatch({
      type: userConstants.LIKE_MOVIE_SUCESS,
      payload: response,
    });
