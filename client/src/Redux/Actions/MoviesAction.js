...
export const getAllMoviesAction =
  ...
  async (dispatch) => {
    try {
      ...
      const respone = await moviesAPIs.getAllMoviesService(
        category,
        time,
        language,
        rate,
      ...
      dispatch({ type: moviesConstants.MOVIES_LIST_SUCCESS, payload: respone });
    } catch (error) {
...
export const getRandomMoviesAction = () => async (dispatch) => {
  try {
    ...
    const respone = await moviesAPIs.getRandomMoviesServices();
    dispatch({
...
export const getMovieByIdAction = (id) => async (dispatch) => {
  try {
    ...
    const respone = await moviesAPIs.getMovieByIdService(id);
    dispatch({
...
export const getTopRatedMovieAction = () => async (dispatch) => {
  try {
    ...
    const respone = await moviesAPIs.getTopRatedMovieService();
    dispatch({
...
export const reviewMovieAction =
  ...
  async (dispatch, getState) => {
    try {
      ...
      const respone = await moviesAPIs.reviewMovieService(
...
export const deleteAllmoviesAction = () => async (dispatch, getState) => {
  try {
    ...
    const response = await moviesAPIs.deleteAllMovieService(
      tokenProtection(getState)
    );
    dispatch({
    ...
    toast.success("ALL Movies deleted sucessfully");
    dispatch(getAllMoviesAction({}));
  } catch (error) {
